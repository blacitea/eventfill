...
Event.create!(user_id: 1, genre_id: 1, location_id: 1, image_url: '/images/event_1.jpg', name: 'Anime Revolution 2020', start: '2020-07-31 12:00:00', end: '2020-08-03 22:00:00', max_attendees: 200, description: 'Join us for another year of Anime, Anime, and more Anime! Anirevo Summer is officially booked for July 31st to August 2nd 2020 at the Vancouver Convention Centre (West Building)!', accepting_talent: true)

Event.create!(user_id: 6, genre_id: 1, location_id: 1, image_url: '/images/event_2.jpg', name: 'Celebrate Jojo 2020', start: '2020-11-20 10:00:00', end: '2020-11-21 19:00:00', max_attendees: 50, description: 'JoJo\'s Bizarre Adventure is a Japanese manga series written and illustrated by Hirohiko Araki. Come and experience the madness of Jojo\'s adventure world.', accepting_talent: false)

Event.create!(user_id: 3, genre_id: 1, location_id: 5, image_url: '/images/event_3.jpeg', name: 'Demon Slayer', start: '2021-01-01 10:00:00', end: '2021-01-02 19:00:00', max_attendees: 50, description: 'Cosplayers welcome! Join us in this event to share our love and watch the 1st episode of season 3 together!', accepting_talent: false)

Event.create!(user_id: 9, genre_id: 1, location_id: 2, image_url: '/images/event_4.jpg', name: 'Volleyball Love!', start: '2020-10-21 10:00:00', end: '2020-10-23 19:00:00', max_attendees: 20, description: 'Celebrating the new season, we are going to have some volleyball match and watch the show after our games!', accepting_talent: false)


Event.create!(user_id: 4, genre_id: 2, location_id: 1, image_url: '/images/event_5.jpg', name: 'Friday Magic!', start: '2020-10-09 10:00:00', end: '2020-10-10 19:00:00', max_attendees: 40, description: 'Come join us to draft a deck and battle each other! We do this every Friday!', accepting_talent: false)

Event.create!(user_id: 4, genre_id: 2, location_id: 1, image_url: '/images/event_6.jpg', name: 'Friday Magic!', start: '2020-10-16 10:00:00', end: '2020-10-17 19:00:00', max_attendees: 40, description: 'Come join us to draft a deck and battle each other! We do this every Friday!', accepting_talent: false)

Event.create!(user_id: 11, genre_id: 2, location_id: 3, image_url: '/images/event_7.jpeg', name: 'EDH Championship', start: '2020-11-10 10:00:00', end: '2020-11-11 19:00:00', max_attendees: 50, description: 'Bring your favourite commander deck and we shall see who\'s the best!', accepting_talent: false)

Event.create!(user_id: 13, genre_id: 2, location_id: 2, image_url: '/images/event_8.jpeg', name: 'Stardard 101!', start: '2020-12-02 10:00:00', end: '2020-12-03 19:00:00', max_attendees: 50, description: 'Want to learn about Magic The Gathering? Join us for some basic and get a starter deck to play with!', accepting_talent: false)




Event.create!(user_id: 8, genre_id: 3, location_id: 5, image_url: '/images/event_9.jpeg', name: 'Marvel Universe!', start: '2020-12-04 10:00:00', end: '2020-12-05 19:00:00', max_attendees: 100, description: 'Hulk? Deadpool? Ghost? Groot? Daredevil? You name it, we have it! Come check it out!', accepting_talent: false)

Event.create!(user_id: 4, genre_id: 3, location_id: 3, image_url: '/images/event_10.jpeg', name: 'Amazing! Spiderman!', start: '2020-12-12 10:00:00', end: '2020-12-13 19:00:00', max_attendees: 100, description: 'Spiderman, Spiderman!
Does whatever a spider he can.
Spins a web any size,
Catches thieves, just like flies.
Look out! Here comes the Spiderman!', accepting_talent: false)

Event.create!(user_id: 5, genre_id: 3, location_id: 4, image_url: '/images/event_11.jpeg', name: 'Justice!', start: '2020-12-22 10:00:00', end: '2020-12-23 19:00:00', max_attendees: 200, description: 'For decades, the Justice League has saved humanity from the worst threats it has ever faced, from alien warlords to ancient demons and powerful sorcerers, to the God of Evil himself, Darkseid. And every time, they have overcome the odds and saved the human race.', accepting_talent: false)

Event.create!(user_id: 3, genre_id: 3, location_id: 4, image_url: '/images/event_12.jpeg', name: 'Snoopy Party!', start: '2020-12-07 10:00:00', end: '2020-12-09 19:00:00', max_attendees: 20, description: 'Snoopy is a loyal, imaginative and good-natured beagle who is prone to imagining fantasy lives, including being an author, a college student known as "Joe Cool", an attorney and a British World War I flying ace. He is perhaps best known in this last persona, wearing an aviator\'s helmet and goggles and a scarf while carrying a swagger stick (like a stereotypical British Army officer of World War I and II).', accepting_talent: false)




Event.create!(user_id: 4, genre_id: 4, location_id: 1, image_url: '/images/event_13.jpeg', name: 'Cute Kittens!', start: '2020-10-11 10:00:00', end: '2020-10-12 19:00:00', max_attendees: 10, description: 'My first handcrafting event! Come see my art and learn how to make yours.', accepting_talent: false)

Event.create!(user_id: 1, genre_id: 4, location_id: 2, image_url: '/images/event_14.jpeg', name: 'Knitting fun!', start: '2020-11-07 10:00:00', end: '2020-11-09 19:00:00', max_attendees: 20, description: 'I am going to hold a small knitting class, if you know your basic and want to get better, bring your yarn and needle!', accepting_talent: false)

Event.create!(user_id: 1, genre_id: 4, location_id: 3, image_url: '/images/event_15.jpeg', name: 'Perfect Fit', start: '2020-11-29 10:00:00', end: '2020-11-30 19:00:00', max_attendees: 5, description: 'Spend your weekend with us and we will make sure you walk away with a pair of perfect fits.', accepting_talent: false)




Event.create!(user_id: 12, genre_id: 5, location_id: 1, image_url: '/images/event_16.jpeg', name: 'Ranked Battles!', start: '2020-10-15 10:00:00', end: '2020-10-17 19:00:00', max_attendees: 20, description: 'Pokémon Sword and Pokémon Shield Ranked Battles October Season Is Here
Battle your fellow Trainers to move up the leaderboard and earn helpful in-game rewards.', accepting_talent: false)

Event.create!(user_id: 12, genre_id: 5, location_id: 2, image_url: '/images/event_17.jpeg', name: 'Squad Strike Teams 3 vs 3!', start: '2020-10-26 10:00:00', end: '2020-10-27 19:00:00', max_attendees: 50, description: 'Gather your team and complete in this 3 vs 3 championship!', accepting_talent: false)

Event.create!(user_id: 3, genre_id: 5, location_id: 4, image_url: '/images/event_18.jpeg', name: 'ASL Season 10 Final!', start: '2020-12-05 10:00:00', end: '2020-12-06 19:00:00', max_attendees: 200, description: 'The AfreecaTV Starleague Season 10 (아프리카TV 스타리그 시즌10) is coming to an end! Come watch the final and cheer for your favourite race!', accepting_talent: false)

Event.create!(user_id: 4, genre_id: 5, location_id: 1, image_url: '/images/event_19.jpeg', name: 'Van TI', start: '2020-11-25 10:00:00', end: '2020-11-27 19:00:00', max_attendees: 100, description: 'Are you disappointed that TI was cancelled? We too! Come play and we will have our Van TI instead!', accepting_talent: false)
