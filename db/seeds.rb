...
Event.create!(user_id: 6, genre_id: 1, location_id: 1, image_url: '/images/event_2.jpg', name: 'Celebrate Jojo 2020', start: '2020-11-20 10:00:00', end: '2020-11-21 19:00:00', max_attendees: 50, description: 'JoJo\'s Bizarre Adventure is a Japanese manga series written and illustrated by Hirohiko Araki. Come and experience the madness of Jojo\'s adventure world. Mauris porttitor consectetur faucibus. Etiam faucibus, massa non consequat commodo, turpis lectus vehicula ante, vitae congue ipsum enim ut metus. Mauris a nisi ac quam porttitor congue. Suspendisse risus tortor, suscipit quis nisl et, dapibus porttitor purus. Quisque id volutpat justo, non tempor magna. Nulla euismod eget orci at vehicula. ', accepting_talent: false)

Event.create!(user_id: 3, genre_id: 1, location_id: 5, image_url: '/images/event_3.jpeg', name: 'Demon Slayer', start: '2021-01-01 10:00:00', end: '2021-01-02 19:00:00', max_attendees: 50, description: 'Cosplayers welcome! Join us in this event to share our love and watch the 1st episode of season 3 together! Etiam a rutrum dolor. Maecenas tincidunt magna ornare pretium interdum. Vivamus eu dui nec mauris consequat rutrum. Etiam arcu purus, posuere non nunc et, accumsan tincidunt neque. Pellentesque vitae consequat eros. Nulla non justo urna. Nam nibh ipsum, dignissim sit amet nunc eu, pharetra eleifend diam.', accepting_talent: false)

Event.create!(user_id: 9, genre_id: 1, location_id: 2, image_url: '/images/event_4.jpg', name: 'Volleyball Love!', start: '2020-10-21 10:00:00', end: '2020-10-23 19:00:00', max_attendees: 20, description: 'Celebrating the new season, we are going to have some volleyball match and watch the show after our games! Mauris porttitor consectetur faucibus. Etiam faucibus, massa non consequat commodo, turpis lectus vehicula ante, vitae congue ipsum enim ut metus. Mauris a nisi ac quam porttitor congue. Suspendisse risus tortor, suscipit quis nisl et, dapibus porttitor purus. Quisque id volutpat justo, non tempor magna. Nulla euismod eget orci at vehicula. ', accepting_talent: false)


Event.create!(user_id: 4, genre_id: 2, location_id: 1, image_url: '/images/event_5.jpg', name: 'Friday Magic!', start: '2020-10-09 10:00:00', end: '2020-10-10 19:00:00', max_attendees: 40, description: 'Come join us to draft a deck and battle each other! We do this every Friday! Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lobortis congue magna ut pulvinar. Integer porttitor risus eu diam aliquam maximus. Sed vestibulum purus semper, eleifend elit eget, bibendum nisi. Sed commodo dolor vitae justo tempus hendrerit. Vivamus mollis, magna eget tempor laoreet, neque risus pulvinar erat, vel porttitor metus dolor non lacus. Duis elementum lacus nec bibendum dictum. Suspendisse augue ante, rhoncus quis facilisis nec, varius quis magna. ', accepting_talent: false)

Event.create!(user_id: 4, genre_id: 2, location_id: 1, image_url: '/images/event_6.jpg', name: 'Friday Magic!', start: '2020-10-16 10:00:00', end: '2020-10-17 19:00:00', max_attendees: 40, description: 'Come join us to draft a deck and battle each other! We do this every Friday! Etiam a rutrum dolor. Maecenas tincidunt magna ornare pretium interdum. Vivamus eu dui nec mauris consequat rutrum. Etiam arcu purus, posuere non nunc et, accumsan tincidunt neque. Pellentesque vitae consequat eros. Nulla non justo urna. Nam nibh ipsum, dignissim sit amet nunc eu, pharetra eleifend diam.', accepting_talent: false)

Event.create!(user_id: 11, genre_id: 2, location_id: 3, image_url: '/images/event_7.jpeg', name: 'EDH Championship', start: '2020-11-10 10:00:00', end: '2020-11-11 19:00:00', max_attendees: 50, description: 'Bring your favourite commander deck and we shall see who\'s the best! Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lobortis congue magna ut pulvinar. Integer porttitor risus eu diam aliquam maximus. Sed vestibulum purus semper, eleifend elit eget, bibendum nisi. Sed commodo dolor vitae justo tempus hendrerit. Vivamus mollis, magna eget tempor laoreet, neque risus pulvinar erat, vel porttitor metus dolor non lacus. Duis elementum lacus nec bibendum dictum. Suspendisse augue ante, rhoncus quis facilisis nec, varius quis magna. ', accepting_talent: false)

Event.create!(user_id: 13, genre_id: 2, location_id: 2, image_url: '/images/event_8.jpeg', name: 'Stardard 101!', start: '2020-12-02 10:00:00', end: '2020-12-03 19:00:00', max_attendees: 50, description: 'Want to learn about Magic The Gathering? Join us for some basic and get a starter deck to play with! Mauris porttitor consectetur faucibus. Etiam faucibus, massa non consequat commodo, turpis lectus vehicula ante, vitae congue ipsum enim ut metus. Mauris a nisi ac quam porttitor congue. Suspendisse risus tortor, suscipit quis nisl et, dapibus porttitor purus. Quisque id volutpat justo, non tempor magna. Nulla euismod eget orci at vehicula. ', accepting_talent: false)




Event.create!(user_id: 8, genre_id: 3, location_id: 5, image_url: '/images/event_9.jpeg', name: 'Marvel Universe!', start: '2020-12-04 10:00:00', end: '2020-12-05 19:00:00', max_attendees: 100, description: 'Hulk? Deadpool? Ghost? Groot? Daredevil? You name it, we have it! Come check it out! Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lobortis congue magna ut pulvinar. Integer porttitor risus eu diam aliquam maximus. Sed vestibulum purus semper, eleifend elit eget, bibendum nisi. Sed commodo dolor vitae justo tempus hendrerit. Vivamus mollis, magna eget tempor laoreet, neque risus pulvinar erat, vel porttitor metus dolor non lacus. Duis elementum lacus nec bibendum dictum. Suspendisse augue ante, rhoncus quis facilisis nec, varius quis magna. ', accepting_talent: false)
...
Event.create!(user_id: 4, genre_id: 4, location_id: 1, image_url: '/images/event_13.jpeg', name: 'Cute Kittens!', start: '2020-10-11 10:00:00', end: '2020-10-12 19:00:00', max_attendees: 10, description: 'My first handcrafting event! Come see my art and learn how to make yours. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lobortis congue magna ut pulvinar. Integer porttitor risus eu diam aliquam maximus. Sed vestibulum purus semper, eleifend elit eget, bibendum nisi. Sed commodo dolor vitae justo tempus hendrerit. Vivamus mollis, magna eget tempor laoreet, neque risus pulvinar erat, vel porttitor metus dolor non lacus. Duis elementum lacus nec bibendum dictum. Suspendisse augue ante, rhoncus quis facilisis nec, varius quis magna. ', accepting_talent: false)
...
Event.create!(user_id: 12, genre_id: 5, location_id: 2, image_url: '/images/event_17.jpeg', name: 'Squad Strike Teams 3 vs 3!', start: '2020-10-26 10:00:00', end: '2020-10-27 19:00:00', max_attendees: 50, description: 'Gather your team and complete in this 3 vs 3 championship! Mauris porttitor consectetur faucibus. Etiam faucibus, massa non consequat commodo, turpis lectus vehicula ante, vitae congue ipsum enim ut metus. Mauris a nisi ac quam porttitor congue. Suspendisse risus tortor, suscipit quis nisl et, dapibus porttitor purus. Quisque id volutpat justo, non tempor magna. Nulla euismod eget orci at vehicula. Sed vitae posuere urna. Morbi vehicula blandit rhoncus. Sed vel pellentesque diam, sed malesuada orci. Aenean faucibus ornare or', accepting_talent: false)
...
Event.create!(user_id: 4, genre_id: 5, location_id: 1, image_url: '/images/event_19.jpeg', name: 'Van TI', start: '2020-11-25 10:00:00', end: '2020-11-27 19:00:00', max_attendees: 100, description: 'Are you disappointed that TI was cancelled? We too! Come play and we will have our Van TI instead!
